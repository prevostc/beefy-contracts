...
contract ProdVaultTest is BaseTestHarness {
    ...
    IBeefyVaultV6 constant vault = IBeefyVaultV6(0x77089478c41b6a8B29dDD6E3cb2F475475A228A5);
    IStrategyComplete strategy;

    // Users
    VaultUser user;
    address constant keeper = 0x340465d9D2EbDE78F15a3870884757584F97aBB4;
    address constant vaultOwner = 0xc8F3D9994bb1670F5f3d78eBaBC35FA8FdEEf8a2; // moonbeam
    address constant strategyOwner = 0xfcDD5a02C611ba6Fe2802f885281500EC95805d7; // moonbeam
